    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='following_by_set', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created'],
            },
        ...
        migrations.AddField(
            ...
            name='followers',
            field=models.ManyToManyField(related_name='following_set', through='account.Contact', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
